...
function init(categroy, that, callback) {
  ...
  console.log("this is catrgory:");
  console.log(categroy);//对应的是四个目录的下标
  console.log("this is that.data:")
  console.log(that.data)
  var temData = that.data.wxaSortPickerData;//A,B,C,D27个数组
  console.log("this is temData:")
  console.log(temData)
...
var textData = {};
    ...
    console.log("helo:this is garbage_sort_data: ")
    console.log(garbage_sort_data)//七大分类目录
    garbage_sort_data.forEach(function (item){
        console.log("helo:this is item: ")
        console.log(item)//对应具体一个目录
    ...
    console.log("this is buildtextdata's textData");
...
function wxaSortPickerTemTagTap(e) {
    var that = this;
    var temData = that.data.wxaSortPickerData;//包含textData,view,wxSortPickertoView
    console.log("wxaSortPickerTemTagTap()里的temData:")
    console.log(temData);
    temData.wxaSortPickertoView = e.target.dataset.tag;
    console.log("temData.wxaSortPickertoView:"+temData.wxaSortPickertoView);//指向的字母
    //console.log(temData)
    that.setData({
        wxaSortPickerData: temData
    });
